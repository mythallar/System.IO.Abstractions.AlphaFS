...
using System.Text;
using AfsFile = Alphaleonis.Win32.Filesystem.File;
...
namespace System.IO.Abstractions.AlphaFS
{
    ...
    public class FileWrapper : FileBase
    {
        ...
        {
            AfsFile.AppendAllLines(path, contents, encoding);
        }

        public override void AppendAllText(string path, string contents)
        {
            AfsFile.AppendAllText(path, contents);
        }

        public override void AppendAllText(string path, string contents, Encoding encoding)
        {
            AfsFile.AppendAllText(path, contents, encoding);
        }
        ...
        {
            AfsFile.Copy(sourceFileName, destFileName);
        }
        ...
        {
            return AfsFile.Create(path, bufferSize, options);
        }
        ...
        {
            AfsFile.Encrypt(path);
        }

        public override bool Exists(string path)
        {
            return AfsFile.Exists(path);
        }

        public override FileSecurity GetAccessControl(string path)
        {
            return AfsFile.GetAccessControl(path);
        }

        public override FileSecurity GetAccessControl(string path, AccessControlSections includeSections)
        {
            return AfsFile.GetAccessControl(path, includeSections);
        }
        ...
        {
            return AfsFile.GetCreationTime(path);
        }

        public override DateTime GetCreationTimeUtc(string path)
        {
            return AfsFile.GetCreationTimeUtc(path);
        }
        ...
        {
            return AfsFile.GetLastAccessTimeUtc(path);
        }

        public override DateTime GetLastWriteTime(string path)
        {
            return AfsFile.GetLastWriteTime(path);
        }

        public override DateTime GetLastWriteTimeUtc(string path)
        {
            return AfsFile.GetLastWriteTimeUtc(path);
        }
        ...
        {
            return AfsFile.Open(path, mode, access);
        }
        ...
        {
            return AfsFile.OpenText(path);
        }

        public override Stream OpenWrite(string path)
        {
            return AfsFile.OpenWrite(path);
        }

        public override byte[] ReadAllBytes(string path)
        {
            return AfsFile.ReadAllBytes(path);
        }
        ...
        {
            return AfsFile.ReadAllText(path);
        }
        ...
        {
            AfsFile.Replace(sourceFileName, destinationFileName, destinationBackupFileName);
        }
        ...
        {
            AfsFile.Replace(sourceFileName, destinationFileName, destinationBackupFileName, ignoreMetadataErrors);
        }

        public override void SetAccessControl(string path, FileSecurity fileSecurity)
        {
            AfsFile.SetAccessControl(path, fileSecurity);
        }
        ...
        {
            AfsFile.SetCreationTime(path, creationTime);
        }

        public override void SetCreationTimeUtc(string path, DateTime creationTimeUtc)
        {
            AfsFile.SetCreationTimeUtc(path, creationTimeUtc);
        }

        public override void SetLastAccessTime(string path, DateTime lastAccessTime)
        {
            AfsFile.SetLastAccessTime(path, lastAccessTime);
        }

        public override void SetLastAccessTimeUtc(string path, DateTime lastAccessTimeUtc)
        {
            AfsFile.SetLastAccessTimeUtc(path, lastAccessTimeUtc);
        }
        ...
        {
            AfsFile.SetLastWriteTimeUtc(path, lastWriteTimeUtc);
        }
